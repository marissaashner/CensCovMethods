...
#' @param weight_stabilize a character string indicating which method of weight stabilization is to be done (if any). One of \code{c("Mean", "KM", "MVN", "None")}.
#' @param se_opt a character string indicating if the weights are assumed to be known or if they are estimated when calculating the sandwich standard error estimate. One of \code{c("known", "est_MVN")}.
#'
