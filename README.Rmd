...
You can install the development version of CensCovMethods from [GitHub](https://github.com/) with:
...
To illustrate the functions in CensCovMethods, let's simulate a dataset for a sample of $n = 500$ observations under $(\sim 40\%)$ random right censoring. Specifically, 
